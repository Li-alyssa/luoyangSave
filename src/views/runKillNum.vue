  ...
  methods: {
    async getChartsList() {
      if (
        ...
        data["type"] = "history";
        let result = await requests.post("/tasktable/getSuccess", data);
        // console.log(result);
        let arr1 = [];
        ...
        data2["type"] = "history";
        let result2 = await requests.post("/tasktable/getSuccess", data2);
        let arr3 = [];
      ...
      if (
        ...
        data3["type"] = "history";
        let result3 = await requests.post("/tasktable/getSuccess", data3);
        // console.log(result);
        let arr5 = [];
