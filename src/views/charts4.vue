...
<template>
  <!-- echarts -->
  <div id="main4" class="main_container"></div>
</template>
  <script>
export default {
  name: "TerminalLine",
  ...
  mounted() {
    this.LineChart = this.$echarts.init(document.getElementById("main4"));
    this.getChartsList();
    // this.getBeforeDate();
  },
  methods: {
    getChartsList() {
      ...
      //   this.LineChartOption.series[0].data = response.data.sysFlow7;
